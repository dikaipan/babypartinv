...
const styles = StyleSheet.create({
    ...
    confirmReceiveActions: {
        flexDirection: 'row',
        gap: 10,
        marginTop: 4,
    },
    confirmReceiveBtnSecondary: {
        flex: 1,
        height: 44,
        borderRadius: 12,
        borderWidth: 1,
    ...
    confirmReceiveBtnSecondaryText: {
        color: Colors.textSecondary,
        fontSize: 13,
        fontWeight: '600',
    },
    confirmReceiveBtnPrimary: {
        flex: 1,
        height: 44,
        borderRadius: 12,
    ...
    confirmReceiveBtnPrimaryDisabled: {
        opacity: 0.7,
    },
    confirmReceiveBtnPrimaryText: {
        color: Colors.bg,
        fontSize: 13,
        fontWeight: '700',
    },
